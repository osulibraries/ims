...
Sufia.config do |config|
  ...
  config.cc_licenses = {
    ...
    'This item, made available for research and educational purposes, may be protected by copyright; the user is responsible for making a final determination of copyright status.' => 'https://library.osu.edu/statements/rights/post-1923/',
    'The Ohio State University Libraries believes this object is in the Public Domain, users are responsible for making a final determination of copyright status before reproducing.' => "https://library.osu.edu/statements/rights/pre-1923/"
  }
  config.preservation_values = {
    'Preservation Master' => 'Preservation Master',
    'Provisional Master' => 'Provisional Master',
    'Derived Master' => 'Derived Master',
  ...
  config.google_analytics_id = 'UA-11024630-1'
 ...
 # config.fits_path = "/Users/sarah/opt/fits-0.6.2/fits.sh"
  ...
  config.after_update_metadata = lambda { |generic_file, user|
    HandleService.new(generic_file).mint
  }
