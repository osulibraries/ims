...
Hydra.configure do |config|
  ...
  config.permissions.inheritable.discover.group       = ActiveFedora::SolrQueryBuilder.solr_name("inheritable_discover_access_group", :symbol)
  config.permissions.inheritable.discover.individual  = ActiveFedora::SolrQueryBuilder.solr_name("inheritable_discover_access_person", :symbol)
  config.permissions.inheritable.read.group           = ActiveFedora::SolrQueryBuilder.solr_name("inheritable_read_access_group", :symbol)
  config.permissions.inheritable.read.individual      = ActiveFedora::SolrQueryBuilder.solr_name("inheritable_read_access_person", :symbol)
  config.permissions.inheritable.edit.group           = ActiveFedora::SolrQueryBuilder.solr_name("inheritable_edit_access_group", :symbol)
  config.permissions.inheritable.edit.individual      = ActiveFedora::SolrQueryBuilder.solr_name("inheritable_edit_access_person", :symbol)
  config.permissions.policy_class = Osul::AdminPolicy
