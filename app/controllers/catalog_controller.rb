...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_index_field solr_name("work_type", :stored_searchable), label: "Genre"
    config.add_index_field solr_name("spatial", :stored_searchable), label: "Spatial"
    config.add_index_field solr_name("alternative", :stored_searchable), label: "Alternative"
    config.add_index_field solr_name("temporal", :stored_searchable), label: "Time Period"
    config.add_index_field solr_name("source", :stored_searchable), label: "Call Number"
    config.add_index_field solr_name("part_of", :stored_searchable), label: "Part Of"
    config.add_index_field solr_name("sub_collection", :stored_searchable), label: "Part Of"
    config.add_index_field solr_name("material", :stored_searchable), label: "Materials"
    ...
    config.add_show_field solr_name("source", :stored_searchable), label: "Call Number"
    config.add_show_field solr_name("sub_collection", :stored_searchable), label: "Part Of"
    config.add_show_field solr_name("material", :stored_searchable), label: "Material"
    config.add_show_field solr_name("part_of", :stored_searchable), label: "Part Of"
    ...
    config.add_search_field('sub_collection') do |field|
      field.solr_parameters = { :"spellcheck.dictionary" => "sub_collection" }
      solr_name = solr_name("sub_collection", :stored_searchable)
      field.solr_local_parameters = {
        qf: solr_name,
        pf: solr_name
      }
    ...
    config.add_search_field('material') do |field|
      field.solr_parameters = { :"spellcheck.dictionary" => "material" }
      solr_name = solr_name("material", :stored_searchable)
      field.solr_local_parameters = {
        qf: solr_name,
        pf: solr_name
      }
    ...
    config.add_search_field('material_type') do |field|
      field.solr_parameters = { :"spellcheck.dictionary" => "material_type" }
    ...
    config.add_search_field('provenance') do |field|
      field.include_in_advanced_search = false
      field.solr_parameters = {
        :"spellcheck.dictionary" => "provenance"
      }
    ...
    config.add_search_field('work_type') do |field|
      field.include_in_advanced_search = false
      field.solr_parameters = {
        :"spellcheck.dictionary" => "work_type"
      }
      solr_name = solr_name("work_type", :stored_searchable)
      field.solr_local_parameters = {
        qf: solr_name,
        pf: solr_name
      }
    ...
    config.add_search_field('alternative') do |field|
      field.include_in_advanced_search = false
      field.solr_parameters = {
        :"spellcheck.dictionary" => "alternative"
      }
      solr_name = solr_name("alternative", :stored_searchable)
      field.solr_local_parameters = {
        qf: solr_name,
        pf: solr_name
      }
